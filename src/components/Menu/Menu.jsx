    ...
    return (
        ...
        <div className="container">
          ...
          <div className="drinks-list">
             <Drink
                    id={0} name="Romano" ordered={false} image="http://localhost:4000/assets/cups/romano.png"
                    layers={[
                      {
                        color: '#fbdf5b',
                        label: 'citrón',
            ...
            < Drink id={1} name="Espresso" ordered={false} image="/cups/espresso.png"/>
            < Drink id={2} name="Doppio" ordered={false} image="/cups/doppio.png"/>
